...
<div class="contenedor">
    ...
    <div class="busqueda1" style="width: 75%; text-align: right">
        <form action="${pageContext.servletContext.contextPath}/Categorias" method="get">
            <input type="text" name="txtBusqueda" id="txtBusqueda" value="${valor}" />
            <input type="submit" value="Buscar"/>
        </form>
        <div class="buttons mgtop-20" >
            <a href="${pageContext.servletContext.contextPath}/Categorias?accion=insertar">Nuevo</a>
        </div>            
    </div>
