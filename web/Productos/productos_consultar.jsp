        ...
        <div>
            ...
            <table>
                <tr>
                    ...
                    <td class="col-lg-4">$ <input type="number" name="txtPrecio1" id="txtPrecio1" value="${p.precioComun}"></td>
                    <td class="col-lg-2">Precio Mayorista</td>
                    <td class="col-lg-4">$ <input type="number" name="txtPrecio2" id="txtPrecio2" value="${p.precioMayorista}"></td>                                               
                </tr>
                <tr>
