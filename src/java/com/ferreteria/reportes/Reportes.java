package com.ferreteria.reportes;
import com.ferreteria.conexion.*;
import java.io.File;
...
public class Reportes extends HttpServlet {
 ...
 if(op.equals("facturar")){
        reportFile = new File(context.getRealPath("/")+"Reportes/Factura.jasper");
        parameters.put("Identificacion", id);}
 ...
 response.setHeader("Content-Disposition", "inline; filename=reporteFactura.pdf");
