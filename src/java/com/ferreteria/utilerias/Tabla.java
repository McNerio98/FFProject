...
public class Tabla {
    ...
    public static final class STYLE {
        ...
        public static final String TABLE01 = "tblStyle1 mgtop-20";
    ...
    private String abrirTabla() {
        ...
        String cab = "<table class='" + estilo + "' style='width:" + ancho + ";" + alin + "'>";
        return cab;
    }
    ...
    private String creaTabla() throws SQLException {
        String[][] rst = rs; //Este es el resulset con los datos        
        ...
        boolean sw = false;
        try {
            while (k < rst[0].length) {// Se va a ejecutar igual al numero de filas, registros que se devuelven
                sw = !sw;
                String color_columna;
                if (sw)//Se intercala para colocar un estilo
                {
                    color_columna = "row-a";
                } else {
                    color_columna = "row-b";
                ...
                for (int i = 0; i < numeroColumnas; i++) {
                    if (getColumnasSeleccionables() == null && getColumnasImagenes() == null) {
                        Tabla += "<td>" + rst[i][k] + "</td>";
                    } else {
                        ...
                        if (getColumnasImagenes()!= null) {
                            boolean found = false;
                            for (int j = 0; j < getColumnasImagenes().length; j++) {
                                if (getColumnasImagenes()[j] == i) {
                                    found = true;
                                    break;
                                }
                            }
                            if (found) {
                                Tabla += "<td><img class=\"imgMarca\" src='" +getRutaImagenes()+ rst[i][k] +"'></td>";
                            }else{
                                Tabla += "<td>" + rst[i][k] + "</td>";
                            }
                        } 
                ...
                if (isEliminable()) {
                    ...
                    if (getIconoEliminable().equals("")) {
                        ...
                        enlaceEliminable = "<img class ='icon' src='" + this.pageContext + getIconoEliminable() + "'/>";
                    }
                    Tabla += "<td>"
                ...
                if (isModificable()) {
                    ...
                    if (getIconoModificable().equals("")) {
                        ...
                        enlaceModificable = "<img class ='icon' src='" + this.pageContext + getIconoModificable() + "'/>";
                    }
...
//           }
    ...
    public String getRutaImagenes(){
        return this.pageContext + rutaImagenes;
    }
    ...
    public int[] getColumnasImagenes() {
        return columnasImagenes;
    }
    ...
    public void setColumnasImagenes(int[] columnasImagenes) {
        this.columnasImagenes = columnasImagenes;
    }
